 ...
 * Ignored #pragma GCC diagnostic ignored "-Wunsafe-buffer-usage"
 * 16/03/2026 J.Venema
 *
 */
...
enum {
  ...
  NPF_DOUBLE_SIGN_POS = sizeof(float) * CHAR_BIT - 1,
...
static NPF_FORCE_INLINE npf_double_bin_t npf_double_to_int_rep(float f) {
