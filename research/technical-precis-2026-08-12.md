...
> Pinned research snapshot dated 2026-08-12. It preserves the evidence basis
> of the feasibility decision and is not fresh-clone setup documentation.

This précis records the compact technical basis for the feasibility decision.
The expanded rationale is in `research/feasibility-study.md`; implementation work is
owned by `TODO.md`.
...
10. The selected initial approach is the strict ongoing compatibility frontend
    specified in `docs/assembly-compatibility-strategy.md`. Maintained source keeps
...
Fab large-file hostfs limitation, recorded in `docs/upstream-findings.md`. The
